  ...
  const ProjectionEngine = (function () {
    ...
    function buildContext(formData, options) {
      ...
      const defaultRates = {
        ...
        investments: resolveFallbackRate(formRates.investments, 0.04),
      };
      ...
      return {
        ...
        assets: {
          current: toNumber(formData.assets?.currentAccount || formData.assets?.checking || 0),
          savings: toNumber(formData.assets?.securitySavings || formData.assets?.savings || 0),
          blocked: toNumber(formData.assets?.blockedAccount || formData.assets?.compteBloque || 0),
          pillar3: toNumber(formData.assets?.pillar3 || formData.assets?.troisiemePiliers || 0),
